...
export const getAlumniUk = () => ({
  ...
  testimonials_section_title: localizeUk('Відгуки випускників'),
  testimonials_section_subtitle: localizeUk('Що кажуть ті, хто вже пройшов навчання'),
...
export const getAlumniEn = () => ({
  ...
  testimonials_section_title: localizeEn(alumniPageEn.testimonials_section_title),
  testimonials_section_subtitle: localizeEn(alumniPageEn.testimonials_section_subtitle),
